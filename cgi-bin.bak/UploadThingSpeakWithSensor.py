...
Fire = 0
Home_Temp = 40
fieldName = ['RPi_temp','Alert','Humidity','Voice','Light','Fire','Home_Temp']
field = [RPi_temp,Alert,Humidity,Voice,Light,Fire,Home_Temp]
...
def alertCheck(data,numField):
	if numField == 3:
		...
		if data < field[numField-1]:
			...
			#print ('''<meta http-equiv="refresh" content="0.1;http://192.168.0.102/cgi-bin/notify.py?data=%s">'''%(fieldName[numField-1]))
			link = "http://192.168.0.102/cgi-bin/notify.py?data="
