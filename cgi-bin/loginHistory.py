  ...
  <body>
     <!-- ==================== Nav Tabs ======================= -->
      ...
      <div class = "container bg-all">        
          ...
          <h4 class="form-signin-heading">Check login history from database</h4>
           ...
           <div class="form-signin">
            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                <h3 class="panel-title">List login access from database</h3>
              </div>
              <div class="panel-body">''')
  print ('''
            <div class="scroll-wrapper">
              <iframe src="loginHistory2.py"></iframe> 
            </div>                 
  ''')
                
  print('''     <form class="btn-form"><a href="/logfiles/loginHistory.log" download="loginHistory.log">Download log file</a></form>
              </div>
            </div>
