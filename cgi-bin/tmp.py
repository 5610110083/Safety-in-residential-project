...
if getCookies() == False:
	...
	print('''
		...
		<div class="panel panel-danger">
			<button class="panel-heading btn btn-lg btn-block" data-toggle="collapse" data-target="#collapseOff" aria-expanded="false" aria-controls="collapseOff" type="button"">
			<h3 class="panel-title">OFF
	  ''')
	# Off mode
	if numMode is '1':
		print('''
	...
	print('''
		...
		<div class="panel panel-success">
			<button class="panel-heading btn btn-lg btn-block" data-toggle="collapse" data-target="#collapseFull" aria-expanded="false" aria-controls="collapseFull" type="button"">
			<h3 class="panel-title">FULL
	''')
	# Full mode
	if numMode is '2':
		print('''
			...
			<div class="collapse" id="collapseFull">
				<div class="panel-body">
					<form action="mode.py" class="btn-form" method="get">
						...
						<!-- apply button -->
						<button data-toggle="modal" data-target="#login-modal-full" class="btn btn-success" name="currentMode" value="2" type="submit" onmouseover="style.color='#33FF33'" onmouseout="style.color='white'">
							Apply
						</button>
